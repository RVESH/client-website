...
export default function TreatmentCard({
  ...
  const contactUrl = `/contact?treatment=${encodeURIComponent(title)}`

  return (
    <article
      className={`treatment-card treatment-card--${variant}`}
    >
      {image && (
        <div className="treatment-card__cover">
          <img
            src={images[image]}
            alt={`${title} at Meridian Dental Studio`}
            loading="lazy"
          />
        </div>
      )}
      ...
      <div className="treatment-card__body">
        ...
        <p className="treatment-card__summary">
          {summary}
        </p>
